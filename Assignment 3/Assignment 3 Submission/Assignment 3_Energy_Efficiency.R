...
Energy_Eff_2012_data<- read.csv("C:/Users/parwa/Desktop/Northeastern/Fall 2017/ADS/Assignments/Energy Efficiency ENB2012_data.csv",header = T)
...
linear_reg <- lm(Y1~X1+X2+X3+X5+X6+X7+X8,data = train_data)
summary(linear_reg)
...
p1= predict(tree_model1,test_data)
